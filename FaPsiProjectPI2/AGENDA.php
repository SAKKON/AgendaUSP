		...
		<div class="justify-content-center card-body h-25 w-100">
			...
			<div class="Citas-main"
				...
				<div>
					...
					<p>Para agendar, selecciona la fecha en la que deseas que se te
						atienda, esta información irá a tu terapeuta el cual podrá
						confirmar si es una fecha ideal. Una vez ambos estén de acuerdo,
						se agendará en el siguiente calendario; en el caso contrario se
						regresará una respuesta y las posibles fechas más cercanas a la
						fecha deseada</p>
				</div>
				<div class="cont-citas">

					<form style="display: inline-block;" method="post">
						<label for="Horario" name="horario">Horario a elegir:</label> <select
							name="horas" id="horas">
						...
						</select> <br> <label for="Día">Fecha a elegir:</label> <select
							name="fecha">
              <?php
            ...
            ?>
            </select> <br> <label for="Especialista">Especialista:</label>
						<select name="especialista" id="especialista">
							<option value="2">Psicólogo</option>
							<option value="1">Psiquiatra</option>
						</select>

						<button type="submit" class="font-weight-bold" id="submitagenda"
							name="submitagenda" formaction="agendacita.php">Agendar cita</button>
			...
			<!-- CUADRO DERECHO -->
			<div style="width: 500px; margin-left: .5vw;"
				class="Citas-main text-center">
				<div>
					<div>
					...
					<div>
						...
						<p>Para revisar tu agenda, selecciona a continuación el botón, en
							donde se desplegará una tabla con tus citas y su respectiva
							información.</p>
					</div>
			...
			<div class="Citas-main text-center mt-4"
				style="margin-left: 100px; background-color: transparent;">
				<a href="http://psicologia.uanl.mx"><button class="btn btn-primary"
						style="border-color: transparent;">Salir a la Facultad de
						Psicología</button></a>
			</div>
