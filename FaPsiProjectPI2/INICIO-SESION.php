...
<html lang="es">
  <head>
    ...
    <title>Iniciar Sesión - FaPsi</title>
  </head>
  <body>
      ...
      <div class="contcont w-100">
        <div class="container w-100">
          ...
          <form action="login-register.php" method="POST">
              ...
              <button type="submit" class="font-weight-bold" id="submit_paciente" name="submit_paciente">Iniciar sesión</button>
			   <button type="submit" class="font-weight-bold" id="submit_psicologo" name="submit_psicologo">Iniciar sesión psicologo</button>
