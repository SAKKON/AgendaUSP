    ...
    <div class="row container-fluid cms py-5">
        ...
        <div class="card text-white purplecolorbkg w-100 cardShadow">
          ...
          <div class="card-body">
            ...
            <a href="http://psicologia.uanl.mx/noticias/ceremonia-de-graduacion-de-la-generacion-2018-2022/" class="col-2 btn btn-yellow text-muted font-weight-bold" style="position: absolute; bottom:10px; right: 20px; width: 110px; min-width: 110px;">Ver Noticia</a>
          </div>
          </div>
          ...
          <div class="card-group purplecolorbkg cardShadow w-100">
              ...
              <div class="card" style="border-right: 1px solid #243A96;">
                ...
                <div class="card-body violetcolorbkg text-white">
                  <h5 class="card-title">Platicas camino al 8M</h5>
                  <p class="card-text"></p>
                  <p class="card-text"><small class="font-weight-bold text-white">Publicado el 07 MARZO</small></p>
                  <a href="http://psicologia.uanl.mx/noticias/platicas-camino-al-8m/" class="btn btn-yellow text-muted font-weight-bold">Ver Noticia</a>
                </div>
              </div>
              ...
              <div class="card" style="border-left: 1px solid #243A96; border-right: 1px solid #243A96;">
                ...
                <div class="card-body violetcolorbkg text-white">
                  <h5 class="card-title">Realiza la Toma de Protesta la Nueva Sociedad de Estudiantes</h5>
                  <p class="card-text"></p>
                  <p class="card-text"><small class="font-weight-bold text-white">Publicado el 31 ABRIL</small></p>
                  <a href="http://psicologia.uanl.mx/noticias/realiza-la-toma-de-protesta-la-nueva-sociedad-de-estudiantes/" class="btn btn-yellow text-muted font-weight-bold">Ver Noticia</a>
                </div>
              </div>
              ...
              <div class="card" style="border-left: 1px solid #243A96;">
                ...
                <div class="card-body violetcolorbkg text-white">
                  <h5 class="card-title">Celebración del Día de las Madres por la Facultad de Psicología, UANL</h5>
                  <p class="card-text"></p>
                  <p class="card-text"><small class="font-weight-bold text-white">Publicado el 10 MAYO</small></p>
                  <a href="http://psicologia.uanl.mx/noticias/celebracion-del-dia-de-las-madres-por-la-facultad-de-psicologia-uanl/" class="btn btn-yellow text-muted font-weight-bold">Ver Noticia</a>
                </div>
              </div>
            </div>
        </div>  
